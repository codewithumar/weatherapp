...
class _WeatherScreenState extends State<WeatherScreen> {
  ...
  late final backgroundfromapi =
      widget.weather.weather![0].main ?? clearbackground;
                    ...
                    child: Column(
                      children: [
                        ThreeDayForcast(
                          ...
                          iconfromapi: widget.hourly.hourly[0].weather![0].main
                              .toString(),
                        ),
                        ThreeDayForcast(
                          day: "Tommorrw",
                          ...
                          iconfromapi: widget.hourly.hourly[1].weather![0].main
                              .toString(),
                        ),
                        ThreeDayForcast(
                          day:
                              convertmillisectotime(widget.hourly.hourly[2].dt!)
                                  .toString(),
                          weatherstatus: widget
                          ...
                          iconfromapi: widget.hourly.hourly[2].weather![0].main
                              .toString(),
                        ),
                      ],
                    ),
  ...
  String convertmillisectotime(int dt) {
    var time = DateTime.fromMillisecondsSinceEpoch(dt);
